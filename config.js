System.config({
  ...
  map: {
    ...
    "npm:cson-parser@1.3.2": {
      "coffee-script": "npm:coffee-script@1.10.0",
      "vm": "github:jspm/nodelibs-vm@0.1.0"
    },
    "npm:cson@3.0.2": {
      "coffee-script": "npm:coffee-script@1.10.0",
      "cson-parser": "npm:cson-parser@1.3.2",
      "extract-opts": "npm:extract-opts@3.2.0",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "requirefresh": "npm:requirefresh@2.0.0",
      "safefs": "npm:safefs@4.0.1",
      "vm": "github:jspm/nodelibs-vm@0.1.0"
    },
    "npm:debug@0.7.4": {
      "process": "github:jspm/nodelibs-process@0.1.2",
    ...
    "npm:eachr@3.1.1": {
      "esnextguardian": "npm:esnextguardian@1.2.1",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "typechecker": "npm:typechecker@4.1.0"
    },
    "npm:elliptic@6.0.2": {
      "bn.js": "npm:bn.js@4.1.1",
    ...
    "npm:extract-opts@3.2.0": {
      "eachr": "npm:eachr@3.1.1",
      "esnextguardian": "npm:esnextguardian@1.2.1",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "typechecker": "npm:typechecker@4.1.0"
